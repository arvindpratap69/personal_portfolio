       ...
       <div class="container-fluid">
         ...
         <div class="mt-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4>Home List</h4>
                <a href="<?php echo e(route('admin.home.create')); ?>" class="btn btn-primary">Add Home Section </a>
            </div>
            <table class="table table-hover table-striped" id="data">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($home->id); ?></td>
                        <td><?php echo e($home->name); ?></td>
                        <td><?php echo e($home->role); ?></td>
                        <td><?php echo e($home->count_projects . '+'); ?></td>
                        <td> <?php echo e($home->experince); ?> </td>
                        <td>
                            
                                 <img src="<?php echo e(url($home->image)); ?>" height="40rem" class="rounded" style="cursor: pointer" 
                                 data-fancybox="gallery" data-src="<?php echo e(asset($home->image)); ?>" 
                                 alt="Sample Image">
                        ...
                        <td>
                            ...
                            <!-- Delete Button -->
                          <a href="javascript:void(0)" class="confirmDelete" module="home" moduleid="<?php echo e($home->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\personal_portfolio\resources\views/admin/home/list.blade.php ENDPATH**/ ?>