       ...
       <div class="container-fluid">
         ...
         <div class="mt-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4>About List</h4>
                <a href="<?php echo e(route('admin.about.create')); ?>" class="btn btn-primary">Add About Section </a>
            </div>
            <table class="table table-hover table-striped" id="data">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>  
                        <img src="<?php echo e(asset($about->admin_image)); ?>" height="40rem" class="rounded" style="cursor: pointer" 
                        data-fancybox="gallery" data-src="<?php echo e(asset($about->admin_image)); ?>" 
                        alt="Sample Image">
                     </td>
                      <td><?php echo e($about->title); ?></td>
                      <td><?php echo e($about->subtitle); ?></td>
                      <td>
                        <img src="<?php echo e(asset($about->image)); ?>" height="40rem" class="rounded" style="cursor: pointer" 
                        data-fancybox="gallery" data-src="<?php echo e(asset($about->image)); ?>" 
                        alt="Sample Image">
                      </td>
                      <td><?php echo e($about->icon_1); ?> </td>
                      <td><?php echo e($about->icon_2); ?> </td>
                      <td><?php echo e($about->icon_3); ?> </td>
                      <td>
                          <a href="<?php echo e(route('admin.about.edit',$about->id)); ?>">
                              <i class="nav-icon bi bi-pencil-square btn btn-primary btn-sm"></i>
                          </a>
                          <a href="javascript:void(0)" class="confirmDelete" module="about" moduleid="<?php echo e($about->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\personal_portfolio\resources\views/admin/about/list.blade.php ENDPATH**/ ?>