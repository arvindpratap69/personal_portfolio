            ...
            <table class="table table-hover table-striped" id="data">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Delete Button -->
                          <a href="javascript:void(0)" class="confirmDelete" module="contact" moduleid="<?php echo e($contact->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\personal_portfolio\resources\views/admin/contact/list.blade.php ENDPATH**/ ?>