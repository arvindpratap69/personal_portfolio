...
<html lang="en">
   ...
   <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <!-- Add this to your main layout file (e.g., app.blade.php) -->
...
<script>
  toastr.options = {
   ...
   <!--end::Body-->
</html><?php /**PATH C:\xampp\htdocs\personal_portfolio\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>