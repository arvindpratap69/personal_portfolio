         ...
         <div class="mt-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="icon1" id="icon1" class="form-control @error('icon1')  is-invalid @enderror" placeholder="Enter Your Icon Name"> 
                    @error('icon1')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
                ...
                <div class="form-group row mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="icon2" id="icon2" class="form-control @error('icon2') is-invalid @enderror" placeholder="Enter Your Icon Name"> 
                    @error('icon2')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
                ...
                <div class="form-group row mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="icon3" id="icon3" class="form-control @error('icon3') is-invalid @enderror" placeholder="Enter Your Icon Name"> 
                    @error('icon3')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
                ...
                <div class="form-group row  mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="subtitle" id="subtitle" class="form-control @error('subtitle') is-invalid @enderror" placeholder="Enter Your subtitle"> 
                    @error('subtitle')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
                ...
                <div class="form-group row  mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Your Admin title"> 
                    @error('title')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
                 ...
                 <div class="form-group row  mt-4">
                  ...
                  <div class="col-sm-10">
                     <textarea style="resize: none; height:80px;"  name="short_description" id="short_description" class="form-control @error('short_description') is-invalid @enderror" placeholder="Enter Your short_description"></textarea>
                ...
                <div class="form-group row  mt-4">
                  ...
                  <div class="col-sm-10">
                     <textarea style="resize: none; height:110px; name="long_description" id="long_description" class="form-control @error('long_description') is-invalid @enderror" placeholder="Enter Your long_description"></textarea>
