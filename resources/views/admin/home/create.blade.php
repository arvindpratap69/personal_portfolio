         ...
         <div class="mt-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group row  mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="role" id="role" class="form-control @error('role') is-invalid @enderror" placeholder="Enter Your Admin Role"> 
                    @error('role')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
                 ...
                 <div class="form-group row  mt-4">
                  ...
                  <div class="col-sm-10">
                     <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" placeholder="Enter Your Description"></textarea>
                     @error('description')
                     <p class="invalid-feedback">{{ $message }}</p>
                      @enderror
                  </div>
                ...
                <div class="col-sm-10">
                  <input type="text" name="count_projects" id="count_projects" class="form-control @error('count_projects') is-invalid @enderror" placeholder="Enter your Total Projects "> 
             ...
             <div class="col-sm-10">
               <input type="text" name="experince" id="experince" class="form-control @error('experince') is-invalid @enderror" placeholder="Enter Your Experience"> 
               @error('experince')
               <p class="invalid-feedback">{{ $message }}</p>
                @enderror
             </div>
