         ...
         <div class="mt-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Your Title"> 
                    @error('title')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
                ...
                <div class="form-group row mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="url" name="project_url" id="project_url" class="form-control @error('project_url') is-invalid @enderror" placeholder="Enter Your Porject_Urls"> 
                    @error('project_url')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
