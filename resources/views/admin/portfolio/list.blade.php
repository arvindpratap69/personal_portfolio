       ...
       <div class="container-fluid">
         ...
         <div class="mt-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4>About List</h4>
                <a href="{{ route('admin.portfolio.create') }}" class="btn btn-primary">Add Portfolio Section </a>
            </div>
            <table class="table table-hover table-striped" id="data">
                ...
                <tbody>
                  ...
                  <tr>
                      <td>{{ $portfolio->id }}</td>
                      <td>  
                        <img src="{{ asset($portfolio->image_path) }}" height="40rem" class="rounded" style="cursor: pointer" 
                        data-fancybox="gallery" data-src="{{ asset($portfolio->image_path) }}" 
                        alt="Sample Image">
                     </td>
                      ...
                      <td>
                          ...
                          <a href="javascript:void(0)" class="confirmDelete" module="portfolio" moduleid="{{ $portfolio->id }}">
