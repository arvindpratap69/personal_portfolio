...
<html lang="en">
   ...
   <head>
      ...
      <title>Personal Portfolio| Forgot Password Page</title>
      ...
      <link rel="stylesheet" href="{{ asset('public/admin/css/adminlte.css') }}" />
      ...
      <div class="login-box">
         ...
         <div class="card">
            <div class="card-body login-card-body">
               ...
               <!-- /.social-auth-links -->
               <p class="mb-1"><a href="{{ route('admin.login') }}">Back Login Page</a></p>
            </div>
            <!-- /.login-card-body -->
         </div>
      </div>
