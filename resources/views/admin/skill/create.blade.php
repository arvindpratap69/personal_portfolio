     ...
     <div class="app-content-header">
       ...
       <div class="container-fluid">
         ...
         <div class="mt-4">
            ...
            <form action="{{ route('admin.skills.store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">   
               @csrf          
            <div class="card-body">
                <div class="form-group row mt-4">
                    <label for="" class="col-sm-2 col-form-lable">Skill_name</label>
                  <div class="col-sm-10">
                    <input type="text" name="skill_name" id="skill_name" class="form-control @error('skill_name') is-invalid @enderror" placeholder="Enter Your skill_name"> 
                    @error('skill_name')
                ...
                <div class="form-group row mt-4">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="proficiency" id="proficiency" class="form-control @error('proficiency') is-invalid @enderror" placeholder="Enter Your proficiency"> 
                    @error('proficiency')
                    <p class="invalid-feedback">{{ $message }}</p>
                     @enderror
                  </div>
